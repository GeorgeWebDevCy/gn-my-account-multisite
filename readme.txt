...
Display all orders from all sites in the multisite network for the current user
...
3. Search for ` GN My Account Multisite` and click 'Install Now' or click on the `upload` link to upload `gn-my-account-multisite.zip`
